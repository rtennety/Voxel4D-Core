...
```
#### Parameters:
* **test_idx_dir**: Path of test indexes, which is generated by the standard VoxelNet evaluation process. 
* **test_results_dir**: Path of occupancy prediction results. Here I simply set it to the path of VoxelNet forecasting results and use the present occupancy prediction results for evaluation. You can also replace them with [OpenOccupancy](https://github.com/JeffWang987/OpenOccupancy) estimation results.
* **gt_dir**: Path of ground-truth segmentations.

##  II. Voxelization of PCP

Voxelization of point cloud prediction requires the outputs of [PCPNet](https://github.com/Blurryface0814/PCPNet). Here I use nuScenes-Occupancy as ground-truth since predicted points are limited by sparsity.
```bash
...
│   │   │   │   │   ├── ...
```
I will provide my PCPNet predictions soon and please open an issue [here](https://github.com/Blurryface0814/PCPNet) if you have questions about how PCPNet is implemented for points forecasting.
...
│   │   │   ├── ...
```
I have provided my [PowerBEV predictions](https://drive.google.com/file/d/1X_N-GwU2ZB65UI9-EYpeQrb2BzS44VVX/view?usp=sharing) and please open an issue [here](https://github.com/EdwardLeeLPZ/PowerBEV) if you have questions about how PowerBEV is implemented for BEV-based instance prediction.
...
If you use my proposed baselines in your work, please cite as:
