...
# Setups =================================================================================================
test_idx_dir = "../../data/Core/test_ids/"
test_results_dir = "../../data/Core/powerbev_results/"
gt_dir = "../../data/Core/MMO/segmentation/"
...
for i in trange(len(test_seqs)):
    ...
    for t in range(3, 7):
        ...
        instance_ = F.interpolate(instance_.float(), size=[500, 500], mode='nearest').contiguous() # Note: default PowerBEV has different ranges with VoxelNet
