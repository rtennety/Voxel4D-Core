...
class VoxelNet(BEVDepth):
    ...
    def forward_train(self,
        ...
        '''
        Train VoxelNet using bbox-wise occupancy labels if self.fine_grained=False, else using voxel-wise labels from nuScenes-Occupancy
        '''
    ...
    def forward_test(self,
        ...
        '''
        Test VoxelNet using IOU and VPQ metrics
        '''
